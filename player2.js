...
class playerState {
    constructor() {
        this.currentPosition = createVector(width / 2, height - 200); // this is the top left corner of the hitbox
    ...
    getStateFromPlayer(player) {
        this.currentPosition = player.currentPosition.copy();
    ...
    loadStateToPlayer(player) {
        player.currentPosition = this.currentPosition.copy();

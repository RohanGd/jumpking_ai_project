...
class Player {
    ...
    show() {
        ...
        if (!replayingBestPlayer) {
            if (this.currentLevel === population.showingLevelNo - 1) {
    ...
    jump() {
        ...
        this.jumpTimer = 0
        this.jumpStartingHeight = (height - this.currentPos.y) + height * this.currentLevel;
        // if (!mutePlayers|| testingSinglePlayer) {
    ...
    CheckForLevelChange() {
        if (this.currentPos.y < -this.height) {
            ...
            // if (!this.hasFinishedInstructions && this.currentLevel < this.bestLevelReached - 1) {
    ...
    // GetGlobalHeight() {
    //     return (height - this.currentPos.y) + height * this.currentLevel
    // }
    ...
    playerLanded() {
        ...
        if (this.jumpStartingHeight - height / 2 > (height - this.currentPos.y) + height * this.currentLevel) {
            this.hasFallen = true;
        }
        ...
        //     if (this.bestLevelReached < this.currentLevel) {
        //         this.bestLevelReached = this.currentLevel;
        ...
        //         this.numberOfCoinsPickedUp = 0;
        //         this.progressionCoinPickedUp = false;
        //         if(!levels[this.currentLevel].hasProgressionCoins){
        ...
        // if (this.currentLevel < this.bestLevelReached && this.currentLevel !== 23 && !this.hasFinishedInstructions) {
        //     this.fellToPreviousLevel = true;
        //     this.fellOnActionNo = this.brain.currentInstructionNumber;
        //     this.hasFinishedInstructions = true;
    ...
    //     if (this.currentLevel < this.bestLevelReached) {
    //         return;
    //     }
    //     let currentLevel = levels[this.currentLevel];
